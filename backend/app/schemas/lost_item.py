"""
Pydantic v2 schemas for LostItem entity.
"""
...
class LostItemBase(BaseModel):
    ...
    location: str = Field(..., min_length=1, max_length=255, description="Location where item was lost")
    latitude: Optional[float] = Field(default=None, ge=-90.0, le=90.0)
    longitude: Optional[float] = Field(default=None, ge=-180.0, le=180.0)
    date_lost: datetime = Field(..., description="Date and time when item was lost")
    reward: Optional[str] = Field(default=None, max_length=100, description="Optional reward offered")
...
class LostItemCreate(LostItemBase):
    user_id: Optional[int] = Field(default=None, description="Owner user ID (set automatically on backend)")
